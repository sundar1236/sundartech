                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-12">
                            <ul className="extra-skills wow fadeInUp delay-0-2s pb-30">
                                <li><i><RiBuilding2Line size={16} /></i>Office:sholinganallur, chennai</li>
                                <li><i><RiHeadphoneLine size={16} /></i>Number:+919080342979</li>
                                <li><i><RiMailOpenLine size={16} /></i>Email:admin@sundartech.com</li>
                            </ul>
